...
function Ya(e, t, n, i, s) {
  ...
  return (
    (n = $a(n)),
    e && e[G] ? e.O(t, n, p(i) ? !!i.capture : !!i, s) : ab(e, t, n, !1, i, s)
  );
}
...
function Za(e, t, n, i, s) {
  ...
  return (
    (n = $a(n)),
    e && e[G] ? e.P(t, n, p(i) ? !!i.capture : !!i, s) : ab(e, t, n, !0, i, s)
  );
}
  ...
  if (null === t.he) {
    ...
    i.forEach((i) => {
      e.has(i.canonicalString()) ||
        i.isKeyField() ||
        t.he.push(new OrderBy(i, n));
    }),
      e.has(FieldPath$1.keyField().canonicalString()) ||
        t.he.push(new OrderBy(FieldPath$1.keyField(), n));
  }
  return t.he;
}
function __PRIVATE_queryToTarget(e) {
  ...
  return (
    t.Pe ||
      (t.Pe = __PRIVATE__queryToTarget(t, __PRIVATE_queryNormalizedOrderBy(e))),
    t.Pe
  );
}
...
class BloomFilter {
  constructor(e, t, n) {
    ...
    (this.Ee = 8 * e.length - t), (this.de = Oe.fromNumber(this.Ee));
  }
  Ae(e, t, n) {
...
class __PRIVATE_DocumentWatchChange {
  constructor(e, t, n, i) {
    (this.me = e), (this.removedTargetIds = t), (this.key = n), (this.fe = i);
  }
}
...
class __PRIVATE_TargetState {
  constructor() {
    (this.pe = 0),
      ...
      (this.we = ByteString.EMPTY_BYTE_STRING),
      (this.Se = !1),
      (this.be = !0);
  }
  get current() {
...
class __PRIVATE_WatchChangeAggregator {
  ...
  it(e, t) {
    ...
    return (
      n.forEach((n) => {
        ...
        e.mightContain(o) || (this.Ge(t, n, null), i++);
      }),
      i
    );
  }
  st(e) {
    ...
    this.qe.forEach((n, i) => {
      ...
      if (s) {
        if (n.current && __PRIVATE_targetIsDocumentTarget(s.target)) {
          ...
          null !== this.Qe.get(t) ||
            this.ot(i, t) ||
            this.Ge(i, t, MutableDocument.newNoDocument(t, e));
        }
        n.Ce && (t.set(i, n.Fe()), n.Me());
      }
    });
    ...
    const i = new RemoteEvent(e, t, this.$e, this.Qe, n);
    return (
      (this.Qe = __PRIVATE_mutableDocumentMap()),
      (this.Ke = __PRIVATE_documentTargetMap()),
      (this.$e = new SortedMap(__PRIVATE_primitiveComparator)),
  ...
  We(e, t) {
    ...
    this.je(e).xe(t.key, n),
      (this.Qe = this.Qe.insert(t.key, t)),
      (this.Ke = this.Ke.insert(t.key, this._t(t.key).add(e)));
  }
  Ge(e, t, n) {
    if (!this.He(e)) return;
    const i = this.je(e);
    this.ot(e, t) ? i.xe(t, 1) : i.Oe(t),
      (this.Ke = this.Ke.insert(t, this._t(t).delete(e))),
...
class __PRIVATE_TargetIndexMatcher {
  ...
  tn(e) {
    if (
      (__PRIVATE_hardAssert(e.collectionGroup === this.collectionId), this.en)
    )
      return !1;
...
class __PRIVATE_IndexedDbIndexManager {
  ...
  createTargetIndexes(e, t) {
    return PersistencePromise.forEach(this.cn(t), (t) =>
  ...
  ln(e, t) {
    ...
    return this.getFieldIndexes(e, i).next((e) => {
      let t = null;
      for (const i of e)
        n.tn(i) && (!t || i.fields.length > t.fields.length) && (t = i);
      return t;
    });
  }
  getIndexType(e, t) {
  ...
  getMinOffset(e, t) {
    return PersistencePromise.mapArray(this.cn(t), (t) =>
      this.ln(e, t).next((e) => e || fail())
...
class __PRIVATE_IndexedDbMutationQueue {
  ...
  vn(e, t) {
    return this.Cn[t]
      ? PersistencePromise.resolve(this.Cn[t])
...
class __PRIVATE_IndexedDbTargetCache {
  ...
  allocateTargetId(e) {
    return this.Ln(e).next((t) => {
      ...
      return (
        ...
        this.kn(e, t).next(() => t.highestTargetId)
      );
    });
  }
  getLastRemoteSnapshotVersion(e) {
    return this.Ln(e).next((e) =>
      SnapshotVersion.fromTimestamp(
        new Timestamp(
  ...
  addTargetData(e, t) {
    return this.qn(e, t).next(() =>
      this.Ln(e).next(
        (n) => ((n.targetCount += 1), this.Qn(t, n), this.kn(e, n))
      )
    );
  }
  ...
  rr(e, t) {
    ...
    return __PRIVATE_remoteDocumentsStore(e)
      .Z(
        ...
        (e, i) => {
          n = { document: this.nr(t, i), size: __PRIVATE_dbDocumentSize(i) };
        }
      )
      .next(() => n);
  }
  ...
  applyChanges(e) {
    ...
    return (
      this.changes.forEach((s, o) => {
        ...
        if (
          (t.push(this.ar.removeEntry(e, s, u.readTime)), o.isValidDocument())
        ) {
...
class __PRIVATE_MemoryDocumentOverlayCache {
  ...
  ht(e, t, n) {
    ...
    let s = this.hr.get(t);
    void 0 === s && ((s = __PRIVATE_documentKeySet()), this.hr.set(t, s)),
      this.hr.set(t, s.add(n.key));
  }
}
...
class __PRIVATE_DocReference {
  ...
  static Ir(e, t) {
    return (
      ...
      __PRIVATE_primitiveComparator(e.pr, t.pr)
    );
  }
  static Er(e, t) {
    return (
...
class __PRIVATE_MemoryMutationQueue {
  ...
  addMutationBatch(e, t, n, i) {
    ...
    for (const t of i)
      (this.wr = this.wr.add(new __PRIVATE_DocReference(t.key, s))),
  ...
  getHighestUnacknowledgedBatchId() {
    return PersistencePromise.resolve(
      0 === this.mutationQueue.length ? -1 : this.yr - 1
    );
  }
  getAllMutationBatches(e) {
  ...
  getAllMutationBatchesAffectingQuery(e, t) {
    ...
    return (
      ...
      PersistencePromise.resolve(this.Dr(u))
    );
  }
  Dr(e) {
    const t = [];
  ...
  removeMutationBatch(e, t) {
    __PRIVATE_hardAssert(0 === this.Cr(t.batchId, "removed")),
  ...
  applyChanges(e) {
    ...
    return (
      this.changes.forEach((n, i) => {
        i.isValidDocument()
          ? t.push(this.ar.addEntry(e, i))
          : this.ar.removeEntry(n);
      }),
      PersistencePromise.waitFor(t)
    );
  }
...
class __PRIVATE_MemoryTargetCache {
  constructor(e) {
    (this.persistence = e),
      ...
      (this.Or = 0),
      (this.Nr = new __PRIVATE_ReferenceSet()),
      (this.targetCount = 0),
      (this.Br = __PRIVATE_TargetIdGenerator.Nn());
  }
  forEachTarget(e, t) {
  ...
  allocateTargetId(e) {
    return (
      (this.highestTargetId = this.Br.next()),
  ...
  qn(e) {
    ...
    t > this.highestTargetId &&
      ((this.Br = new __PRIVATE_TargetIdGenerator(t)),
...
class __PRIVATE_MemoryPersistence {
  constructor(e, t) {
    (this.Lr = {}),
      (this.overlays = {}),
      (this.kr = new __PRIVATE_ListenSequence(0)),
      (this.qr = !1),
      (this.qr = !0),
  ...
  runTransaction(e, t, n) {
    ...
    return (
      ...
      n(i)
        .next((e) => this.referenceDelegate.Wr(i).next(() => e))
        .toPromise()
  ...
  Gr(e, t) {
    return PersistencePromise.or(
      Object.values(this.Lr).map((n) => () => n.containsKey(e, t))
    );
  }
}
...
class __PRIVATE_MemoryLruDelegate {
  ...
  Jn(e, t) {
    return PersistencePromise.forEach(this.Zr, (n, i) =>
      this.er(e, n, i).next((e) => (e ? PersistencePromise.resolve() : t(i)))
    );
  }
  removeTargets(e, t, n) {
  ...
  markPotentiallyOrphaned(e, t) {
    return (
      this.Zr.set(t, e.currentSequenceNumber), PersistencePromise.resolve()
    );
  }
  removeTarget(e, t) {
    const n = t.withSequenceNumber(e.currentSequenceNumber);
  ...
  addReference(e, t, n) {
    return (
      this.Zr.set(n, e.currentSequenceNumber), PersistencePromise.resolve()
    );
  }
  removeReference(e, t, n) {
    return (
...
class __PRIVATE_SchemaConverter {
  ...
  B(e, t, n, i) {
      ...
      (function __PRIVATE_createMutationQueue(e) {
        e.createObjectStore("mutationQueues", { keyPath: "userId" }),
          e
            ...
            .createIndex("userMutationsIndex", Qe, { unique: !0 }),
    ...
    return (
      ...
      n < 7 && i >= 7 && (o = o.next(() => this.ti(s))),
      n < 8 && i >= 8 && (o = o.next(() => this.ni(e, s))),
      n < 9 &&
        i >= 9 &&
        (o = o.next(() => {
      ...
      n < 14 && i >= 14 && (o = o.next(() => this.si(e, s))),
      n < 15 &&
        i >= 15 &&
        (o = o.next(() =>
  ...
  si(e, t) {
    const n = t.store("mutations"),
      ...
      s = new __PRIVATE_MemoryPersistence(
        __PRIVATE_MemoryEagerDelegate.Hr,
        this.serializer.ct
      );
    return n.G().next((e) => {
      const n = new Map();
...
class __PRIVATE_IndexedDbPersistence {
  constructor(e, t, n, i, s, o, u, l, _, h, d = 15) {
    ...
    (this.referenceDelegate = new __PRIVATE_IndexedDbLruDelegateImpl(this, i)),
      ...
      (this.$r = new __PRIVATE_IndexedDbBundleCache()),
  ...
  Ai() {
    return this.runTransaction(
      ...
      .then((e) => {
        this.isPrimary !== e && this.oi.enqueueRetryable(() => this.Ii(e)),
          (this.isPrimary = e);
      });
  }
  gi(e) {
    return __PRIVATE_primaryClientStore(e)
      .get("owner")
      .next((e) => PersistencePromise.resolve(this.Si(e)));
  }
  bi(e) {
    ...
    return this.ai
      ...
      : __PRIVATE_primaryClientStore(e)
          ...
          .next((t) => {
            if (
              null !== t &&
              this.Ci(t.leaseTimestampMs, 5e3) &&
              !this.Mi(t.ownerId)
            ) {
    ...
    return this.Ei.runTransaction(
      ...
      (i) => (
        (o = new __PRIVATE_IndexedDbTransaction(
          i,
          this.kr ? this.kr.next() : __PRIVATE_ListenSequence.ae
        )),
        "readwrite-primary" === t
          ? this.gi(o)
              .next((e) => !!e || this.pi(o))
  ...
  Ni() {
    this.ci &&
      (this.window.removeEventListener("pagehide", this.ci), (this.ci = null));
  }
  Mi(e) {
    var t;
    try {
...
class __PRIVATE_QueryEngine {
  constructor() {
    (this.$i = !1), (this.Ui = !1), (this.Wi = 100), (this.Gi = 8);
  }
  initialize(e, t) {
      ...
      0 === i
        ...
        : (null !== t.limit &&
          ...
          this.indexManager.getDocumentsMatchingTarget(e, n).next((i) => {
            ...
            return this.zi.getDocuments(e, s).next((i) =>
              this.indexManager.getMinOffset(e, n).next((n) => {
                const o = this.Zi(t, i);
                return this.Xi(t, o, s, n.readTime)
                  ? this.ji(e, __PRIVATE_queryWithLimit(t, null, "F"))
                  : this.es(e, o, t, n);
              })
            );
          }))
  ...
  Hi(e, t, n, i) {
    return __PRIVATE_queryMatchesAllDocuments(t) ||
      ...
      : this.zi.getDocuments(e, n).next((s) => {
          const o = this.Zi(t, s);
          return this.Xi(t, o, n, i)
            ? PersistencePromise.resolve(null)
            : (__PRIVATE_getLogLevel() <= l.DEBUG &&
                __PRIVATE_logDebug(
                  "QueryEngine",
  ...
  es(e, t, n, i) {
    return this.zi.getDocumentsMatchingQuery(e, n, i).next(
      (e) => (
        t.forEach((t) => {
          e = e.insert(t.key, t);
        }),
  ...
  return await n.persistence.runTransaction(
    ...
    (e) => {
      ...
      return n.mutationQueue
        .getAllMutationBatches(e)
        .next(
          (s) => ((i = s), n._s(t), n.mutationQueue.getAllMutationBatches(e))
        )
        .next((t) => {
          const s = [],
            o = [];
          ...
          return n.localDocuments
            .getDocuments(e, u)
            .next((e) => ({ us: e, removedBatchIds: s, addedBatchIds: o }));
        });
    }
  );
}
...
function __PRIVATE_localStoreAllocateTarget(e, t) {
  ...
  return n.persistence
    .runTransaction("Allocate target", "readwrite", (e) => {
      let i;
      return n.Qr.getTargetData(e, t).next((s) =>
        s
  ...
  return i.persistence.runTransaction("Execute query", "readwrite", (e) =>
    (function __PRIVATE_localStoreGetTargetData(e, t, n) {
      const i = __PRIVATE_debugCast(e),
        s = i.rs.get(n);
      return void 0 !== s
        ? PersistencePromise.resolve(i.ns.get(s))
...
class __PRIVATE_WebStorageSharedClientState {
  constructor(e, t, n, i, s) {
    (this.window = e),
      ...
      (this.ps = new SortedMap(__PRIVATE_primitiveComparator)),
      (this.started = !1),
      (this.ys = []);
    const o = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    (this.storage = this.window.localStorage),
      (this.currentUser = s),
      (this.ws = createWebStorageClientStateKey(this.persistenceKey, this.Vs)),
      (this.Ss = (function createWebStorageSequenceNumberKey(e) {
        return `firestore_sequence_number_${e}`;
      })(this.persistenceKey)),
      (this.ps = this.ps.insert(this.Vs, new __PRIVATE_LocalClientState())),
      (this.bs = new RegExp(`^firestore_clients_${o}_([^_]*)$`)),
      (this.Ds = new RegExp(`^firestore_mutations_${o}_(\\d+)(?:_(.*))?$`)),
      (this.Cs = new RegExp(`^firestore_targets_${o}_(\\d+)$`)),
      (this.vs = (function createWebStorageOnlineStateKey(e) {
        return `firestore_online_state_${e}`;
      })(this.persistenceKey)),
      (this.Fs = (function createBundleLoadedKey(e) {
...
class __PRIVATE_MemorySharedClientState {
  constructor() {
    (this.no = new __PRIVATE_LocalClientState()),
      (this.ro = {}),
      (this.onlineStateHandler = null),
      (this.sequenceNumberHandler = null);
  }
...
class __PRIVATE_WebChannelConnection extends class __PRIVATE_RestConnection {
  ...
  Fo(e, t, n) {
    ...
    void 0 !== _ && (l.longPollingTimeout = Math.round(1e3 * _)),
      ...
      this.Do(l.initMessageHeaders, t, n),
...
class __PRIVATE_ExponentialBackoff {
  ...
  qo(e) {
    ...
    i > 0 &&
      __PRIVATE_logDebug(
        "ExponentialBackoff",
        `Backing off for ${i} ms (base delay: ${this.No} ms, delay with jitter: ${t} ms, last attempt: ${n} ms ago)`
      ),
...
class __PRIVATE_PersistentStream {
  constructor(e, t, n, i, s, o, u, l) {
    (this.oi = e),
      ...
      (this.zo = null),
      (this.stream = null),
      (this.jo = new __PRIVATE_ExponentialBackoff(e, t));
  }
  Ho() {
  ...
  So(e, t, n) {
    return (
      ...
      Promise.all([
        ...
        .then(([i, s]) => this.connection.So(e, t, n, i, s))
        .catch((e) => {
  ...
  vo(e, t, n, i) {
    return (
      ...
      Promise.all([
        ...
        .then(([s, o]) => this.connection.vo(e, t, n, s, o, i))
        .catch((e) => {
          throw "FirebaseError" === e.name
            ? (e.code === $e.UNAUTHENTICATED &&
                (this.authCredentials.invalidateToken(),
...
class __PRIVATE_OnlineStateTracker {
  ...
  w_(e) {
    ...
    this.g_
      ? (__PRIVATE_logError(t), (this.g_ = !1))
...
async function __PRIVATE_enableNetworkInternal(e) {
  if (__PRIVATE_canUseNetwork(e)) for (const t of e.F_) await t(!0);
}
...
function __PRIVATE_remoteStoreUnlisten(e, t) {
  ...
  n.C_.delete(t),
    i.Jo() && __PRIVATE_sendUnwatchRequest(n, t),
    0 === n.C_.size &&
      (i.Jo() ? i.Xo() : __PRIVATE_canUseNetwork(n) && n.x_.set("Unknown"));
}
...
function __PRIVATE_shouldStartWatchStream(e) {
  return (
    ...
    !__PRIVATE_ensureWatchStream(e).Ho() &&
    e.C_.size > 0
  );
}
...
async function __PRIVATE_onWatchStreamClose(e, t) {
  __PRIVATE_cleanUpWatchStreamState(e),
    __PRIVATE_shouldStartWatchStream(e)
      ? (e.x_.S_(t), __PRIVATE_startWatchStream(e))
      : e.x_.set("Unknown");
}
...
function __PRIVATE_shouldStartWriteStream(e) {
  return (
    __PRIVATE_canUseNetwork(e) &&
    !__PRIVATE_ensureWriteStream(e).Ho() &&
    e.D_.length > 0
  );
}
  ...
  t &&
    ...
    (await (async function __PRIVATE_handleWriteError(e, t) {
      if (
        ...
        const n = e.D_.shift();
        __PRIVATE_ensureWriteStream(e).Zo(),
          await __PRIVATE_executeWithRecovery(e, () =>
...
async function __PRIVATE_remoteStoreApplyPrimaryState(e, t) {
  const n = __PRIVATE_debugCast(e);
  t
    ? (n.v_.delete(2), await __PRIVATE_enableNetworkInternal(n))
    : t ||
      (n.v_.add(2),
      await __PRIVATE_disableNetworkInternal(n),
      n.x_.set("Unknown"));
...
function __PRIVATE_ensureWriteStream(e) {
  return (
    e.B_ ||
      ...
      e.F_.push(async (t) => {
        t
          ? (e.B_.Zo(), await __PRIVATE_fillWritePipeline(e))
          : (await e.B_.stop(),
            e.D_.length > 0 &&
              (__PRIVATE_logDebug(
                "RemoteStore",
  ...
  track(e) {
    ...
    n
      ? 0 !== e.type && 3 === n.type
        ...
        : 3 === e.type && 1 !== n.type
        ? (this.L_ = this.L_.insert(t, { type: n.type, doc: e.doc }))
        : 2 === e.type && 2 === n.type
        ? (this.L_ = this.L_.insert(t, { type: 2, doc: e.doc }))
        : 2 === e.type && 0 === n.type
        ? (this.L_ = this.L_.insert(t, { type: 0, doc: e.doc }))
        : 1 === e.type && 0 === n.type
        ? (this.L_ = this.L_.remove(t))
        : 1 === e.type && 2 === n.type
        ? (this.L_ = this.L_.insert(t, { type: 1, doc: n.doc }))
        : 0 === e.type && 1 === n.type
        ? (this.L_ = this.L_.insert(t, { type: 2, doc: e.doc }))
        : fail()
      : (this.L_ = this.L_.insert(t, e));
...
async function __PRIVATE_eventManagerListen(e, t) {
  ...
  n.queries.set(i, o),
    o.listeners.push(t),
    t.K_(n.onlineState),
    o.q_ && t.U_(o.q_) && __PRIVATE_raiseSnapshotsInSyncEvent(n);
}
...
function __PRIVATE_eventManagerOnWatchChange(e, t) {
  ...
  for (const e of t) {
    const t = e.query,
      s = n.queries.get(t);
    if (s) {
      for (const t of s.listeners) t.U_(e) && (i = !0);
      s.q_ = e;
    }
  }
...
class __PRIVATE_QueryListener {
  ...
  U_(e) {
    ...
    return (
      this.G_
        ? this.j_(e) && (this.W_.next(e), (t = !0))
        : this.H_(e, this.onlineState) && (this.J_(e), (t = !0)),
      (this.z_ = e),
      t
    );
  }
...
class __PRIVATE_BundleLoader {
  ...
  ta(e) {
    ...
    if (e.Z_.namedQuery) this.queries.push(e.Z_.namedQuery);
      ...
      this.documents.push({ metadata: e.Z_.documentMetadata }),
        e.Z_.documentMetadata.exists || ++t;
      const n = ResourcePath.fromString(e.Z_.documentMetadata.name);
      this.collectionGroups.add(n.get(n.length - 2));
    } else
      e.Z_.document &&
        ((this.documents[this.documents.length - 1].document = e.Z_.document),
        ++t);
  ...
  async complete() {
    const e = await (async function __PRIVATE_localStoreApplyBundledDocuments(
        ...
        const l = s.os.newChangeBuffer({ trackRemovals: !0 }),
        ...
        return s.persistence.runTransaction(
          ...
          (e) =>
            __PRIVATE_populateDocumentChangeBuffer(e, l, u)
              .next((t) => (l.apply(e), t))
              .next((t) =>
                s.Qr.removeMatchingKeysForTargetId(e, _.targetId)
                  .next(() => s.Qr.addMatchingKeys(e, o, _.targetId))
                  .next(() =>
                    s.localDocuments.getLocalViewOfDocuments(e, t.cs, t.ls)
                  )
                  .next(() => t.cs)
              )
        );
    ...
    return (
      ...
      { progress: this.progress, ra: this.collectionGroups, ia: e }
    );
  }
}
...
class __PRIVATE_View {
  ...
  la(e, t) {
    const n = t ? t.ha : new __PRIVATE_DocumentChangeSet(),
      i = t ? t.ua : this.ua;
        ...
        h && d
          ? h.data.isEqual(d.data)
            ...
            : this.Pa(h, d) ||
              ...
              (g = !0),
              ((l && this.aa(d, l) > 0) || (_ && this.aa(d, _) < 0)) &&
                (u = !0))
          : !h && d
    ...
    return { ua: o, ha: n, Xi: u, mutatedKeys: s };
  }
  Pa(e, t) {
    return (
  ...
  applyChanges(e, t, n) {
    ...
    s.sort(
      ...
      this.Ia(n);
    const o = t ? this.Ta() : [],
      u = 0 === this._a.size && this.current ? 1 : 0,
      l = u !== this.oa;
    return (
      (this.oa = u),
      0 !== s.length || l
  ...
  da(e) {
    return (
      !this.sa.has(e) && !!this.ua.has(e) && !this.ua.get(e).hasLocalMutations
    );
  }
  Ia(e) {
    e &&
      (e.addedDocuments.forEach((e) => (this.sa = this.sa.add(e))),
      e.modifiedDocuments.forEach((e) => {}),
      e.removedDocuments.forEach((e) => (this.sa = this.sa.delete(e))),
...
class __PRIVATE_SyncEngineImpl {
  constructor(e, t, n, i, s, o) {
    (this.localStore = e),
      ...
      (this.wa = new Map()),
      (this.Sa = new __PRIVATE_ReferenceSet()),
      (this.ba = {}),
      (this.Da = new Map()),
      (this.Ca = __PRIVATE_TargetIdGenerator.Bn()),
      (this.onlineState = "Unknown"),
      (this.va = void 0);
  }
  get isPrimaryClient() {
...
async function __PRIVATE_initializeViewAndComputeSnapshot(e, t, n, i, s) {
    ...
    (async function __PRIVATE_applyDocChanges(e, t, n, i) {
      ...
      s.Xi &&
        (s = await __PRIVATE_localStoreExecuteQuery(
          ...
          t.query,
          !1
        ).then(({ documents: e }) => t.view.la(e, s)));
  ...
  return (
    e.fa.set(t, d),
    e.ga.has(n) ? e.ga.get(n).push(t) : e.ga.set(n, [t]),
    h.snapshot
  );
}
      ...
      return n.persistence
        .runTransaction("Apply remote event", "readwrite-primary", (e) => {
          ...
          t.targetChanges.forEach((o, l) => {
            ...
            if (!_) return;
            u.push(
              n.Qr.removeMatchingKeys(e, o.removedDocuments, l).next(() =>
                n.Qr.addMatchingKeys(e, o.addedDocuments, l)
              )
            );
    ...
    t.targetChanges.forEach((e, t) => {
      ...
      i &&
        ...
        e.addedDocuments.size > 0
          ...
          ? __PRIVATE_hardAssert(i.Va)
          : e.removedDocuments.size > 0 &&
            (__PRIVATE_hardAssert(i.Va), (i.Va = !1)));
    }),
    ...
    i.fa.forEach((n, i) => {
      ...
      (function __PRIVATE_eventManagerOnOnlineStateChange(e, t) {
        ...
        n.queries.forEach((e, n) => {
          for (const e of n.listeners) e.K_(t) && (i = !0);
        }),
          i && __PRIVATE_raiseSnapshotsInSyncEvent(n);
      })(i.eventManager, t),
      e.length && i.ma.u_(e),
...
function __PRIVATE_removeAndCleanupTarget(e, t, n = null) {
  ...
  for (const i of e.ga.get(t)) e.fa.delete(i), n && e.ma.Ma(i, n);
  e.ga.delete(t),
    e.isPrimaryClient &&
      e.Sa.Vr(t).forEach((t) => {
        e.Sa.containsKey(t) || __PRIVATE_removeLimboTarget(e, t);
      });
}
...
function __PRIVATE_updateTrackedLimbos(e, t, n) {
  for (const i of n)
    i instanceof __PRIVATE_AddedLimboDocument
      ? (e.Sa.addReference(i.key, t), __PRIVATE_trackLimboChange(e, i))
      : i instanceof __PRIVATE_RemovedLimboDocument
      ? (__PRIVATE_logDebug(
          "SyncEngine",
          "Document no longer in limbo: " + i.key
        ),
        e.Sa.removeReference(i.key, t),
        e.Sa.containsKey(i.key) || __PRIVATE_removeLimboTarget(e, i.key))
      : fail();
}
...
function __PRIVATE_pumpEnqueuedLimboResolutions(e) {
  for (; e.pa.size > 0 && e.ya.size < e.maxConcurrentLimboResolutions; ) {
    ...
    const n = new DocumentKey(ResourcePath.fromString(t)),
      i = e.Ca.next();
    e.wa.set(i, new LimboResolution(n)),
      (e.ya = e.ya.insert(n, i)),
...
async function __PRIVATE_syncEngineHandleCredentialChange(e, t) {
  ...
  if (!n.currentUser.isEqual(t)) {
    ...
    (n.currentUser = t),
      ...
      await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(n, e.us);
  }
}
function __PRIVATE_syncEngineGetRemoteKeysForTarget(e, t) {
  const n = __PRIVATE_debugCast(e),
    i = n.wa.get(t);
  if (i && i.Va) return __PRIVATE_documentKeySet().add(i.key);
  {
    let e = __PRIVATE_documentKeySet();
    const i = n.ga.get(t);
    if (!i) return e;
...
function __PRIVATE_ensureWatchCallbacks(e) {
  ...
  return (
    ...
    (t.ma.u_ = __PRIVATE_eventManagerOnWatchChange.bind(null, t.eventManager)),
    (t.ma.Ma = __PRIVATE_eventManagerOnWatchError.bind(null, t.eventManager)),
    t
  );
}
  ...
  createPersistence(e) {
    const t =
      void 0 !== this.cacheSizeBytes
        ...
        : LruParams.DEFAULT;
    return new __PRIVATE_MemoryPersistence(
      (e) => __PRIVATE_MemoryLruDelegate.Hr(e, t),
      this.serializer
    );
  }
}
class __PRIVATE_IndexedDbOfflineComponentProvider extends MemoryOfflineComponentProvider {
  ...
  async initialize(e) {
    await super.initialize(e),
      await this.Oa.initialize(this, e),
      await __PRIVATE_syncEngineEnsureWriteCallbacks(this.Oa.syncEngine),
      await __PRIVATE_fillWritePipeline(this.Oa.remoteStore),
            ...
            n.ga.forEach((i, s) => {
              ...
              (function __PRIVATE_resetLimboDocuments(e) {
                ...
                t.wa.forEach((e, n) => {
                  ...
                  t.Sa.mr(),
                  (t.wa = new Map()),
                  (t.ya = new SortedMap(DocumentKey.comparator));
              })(n),
              (n.va = !1),
              await __PRIVATE_remoteStoreApplyPrimaryState(n.remoteStore, !1);
          }
        })(this.Oa.syncEngine, e),
          this.gcScheduler &&
...
class __PRIVATE_BundleReaderImpl {
  constructor(e, t) {
    (this.La = e),
      ...
      (this.ka = (function __PRIVATE_newTextDecoder() {
        return new TextDecoder("utf-8");
      })()),
      this.qa().then(
        (e) => {
          e && e.X_()
            ? this.metadata.resolve(e.Z_.metadata)
  ...
  async Qa() {
    for (; this.Ua() < 0 && !(await this.Wa()); );
    if (0 === this.buffer.length) return null;
    const e = this.Ua();
    e < 0 &&
      this.Ka("Reached the end of bundle when a length string is expected.");
  ...
  async $a(e) {
    for (; this.buffer.length < e; )
      (await this.Wa()) &&
        this.Ka("Reached the end of bundle when more is expected.");
  ...
  async lookup(e) {
    ...
    const t = await (async function __PRIVATE_invokeBatchGetDocumentsRpc(e, t) {
      const n = __PRIVATE_debugCast(e),
        ...
        o = await n.vo("BatchGetDocuments", i, s, t.length),
        u = new Map();
      o.forEach((e) => {
...
class __PRIVATE_TransactionRunner {
  ...
  Ha(e) {
    this.Ga > 0 && this.Ja(e)
      ? ((this.Ga -= 1),
        this.asyncQueue.enqueueAndForget(() => (this.za(), Promise.resolve())))
    ...
    !(function __PRIVATE_syncEngineLoadBundle(e, t, n) {
      ...
      (async function __PRIVATE_loadBundleImpl(e, t, n) {
        try {
          ...
          let o = await t.xa();
          for (; o; ) {
            const e = await s.ta(o);
            e && n._updateProgress(e), (o = await t.xa());
          }
...
class __PRIVATE_AsyncQueueImpl {
  constructor() {
    (this.Ya = Promise.resolve()),
      ...
      (this.ru = !1),
      (this.iu = []),
      (this.jo = new __PRIVATE_ExponentialBackoff(this, "async_queue_retry")),
      (this.su = () => {
        const e = getDocument();
        e &&
          __PRIVATE_logDebug(
  ...
  enqueue(e) {
    if ((this.ou(), this.Xa)) return new Promise(() => {});
...
class __PRIVATE_ParseContextImpl {
  ...
  mu(e) {
    return this.Eu({ path: void 0, Au: !0 });
  }
  fu(e) {
  ...
  Iu() {
    if (this.path)
      for (let e = 0; e < this.path.length; e++) this.Ru(this.path.get(e));
  }
  Ru(e) {
...
function __PRIVATE_parseSetData(e, t, n, i, s, o = {}) {
  const u = e.yu(o.merge || o.mergeFields ? 2 : 0, t, n, s);
...
function __PRIVATE_createSentinelChildContext(e, t, n) {
  return new __PRIVATE_ParseContextImpl(
    { Tu: 3, pu: t.settings.pu, methodName: e._methodName, Au: n },
    t.databaseId,
    t.serializer,
    t.ignoreUndefinedProperties
  );
...
class __PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(e) {
    const t = __PRIVATE_createSentinelChildContext(this, e, !0),
      n = this.wu.map((e) => __PRIVATE_parseData(e, t)),
...
function __PRIVATE_parseQueryValue(e, t, n, i = !1) {
  return __PRIVATE_parseData(n, e.yu(i ? 4 : 3, t));
}
function __PRIVATE_parseData(e, t) {
  ...
  if ((t.path && t.fieldMask.push(t.path), e instanceof Array)) {
    ...
    return (function __PRIVATE_parseArray(e, t) {
      ...
      let i = 0;
      for (const s of e) {
        let e = __PRIVATE_parseData(s, t.mu(i));
...
function __PRIVATE_parseObject(e, t) {
  ...
  return (
    isEmpty(e)
      ...
      : forEach(e, (e, i) => {
          const s = __PRIVATE_parseData(i, t.du(e));
          null != s && (n[e] = s);
        }),
    { mapValue: { fields: n } }
  );
...
function __PRIVATE_validatePlainObject(e, t, n) {
  if (
    ...
    throw "an object" === i ? t.fu(e + " a custom object") : t.fu(e + " " + i);
  }
}
          ...
          try {
            ...
            i.sharedClientState.addPendingMutation(e.batchId),
              (function __PRIVATE_addMutationCallback(e, t, n) {
                let i = e.ba[e.currentUser.toKey()];
                i || (i = new SortedMap(__PRIVATE_primitiveComparator)),
                  (i = i.insert(t, n)),
                  (e.ba[e.currentUser.toKey()] = i);
              })(i, e.batchId, n),
              await __PRIVATE_syncEngineEmitNewSnapsAndNotifyLocalStore(
                i,
                e.changes
        ...
        try {
          ...
          i.resolve(
            (async function __PRIVATE_invokeRunAggregationQueryRpc(e, t, n) {
              ...
              const _ = (await s.vo("RunAggregationQuery", l, o, 1)).filter(
                (e) => !!e.result
              );
